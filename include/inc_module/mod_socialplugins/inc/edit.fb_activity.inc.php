...
<form action="<?php echo fb_map_url( array('controller=fb_activity', 'edit='.$plugin_fb['data']['fb_id']) ) ?>" name="frmfb_activity" method="post">
<input name="fb_id" type="hidden" value="<?php echo $plugin_fb['data']['fb_id'] ?>" />
<table width="100%" summary="" class="br_module_table">

  <tr>
		<td colspan="2">
      <div class="br_module_title"><?php echo $BLM['tit_activity']; ?>
	...
	<tr>
    <td colspan="2"><div id="t1-content" class="togglecontent"><span>When a user clicks a link back to your website, Facebook will pass back this ref parameter in the referrer URL. Example:
  ...
  <tr>
	...
	<tr>
		<td></td>
    <td><input name="fb_site_url_fix" id="param_fb_site_url_fix" type="checkbox" value="1"<?php is_checked($plugin_fb['data']['values']['fb_site_url_fix'], 1) ?> /><label for="param_fb_site_url_fix">Use current Domain:</label> <input type=hidden name="fb_phpwcms_url" id="param_fb_phpwcms_url" value="<?php echo urlencode(PHPWCMS_URL) ?>" /><strong><?php echo PHPWCMS_URL ?></strong></td>
	</tr>

	<tr>
		<td></td>
    <td><?php echo $BLM['fb_url_warning'] ?></td>
	</tr>
...
&nbsp;<?php echo $BLM['fb_lyt_wxh'] ?></td>
	...
	<tr>
		<td></td>
    <td>Defaults to 300px x 300px</td>
	</tr>
  ...
  <tr>
		<td><?php echo $BLM['fb_show_recom'] ?>:</td>
		<td>
      <input name="fb_show_recom" id="param_fb_show_recom" type="checkbox" value="1"<?php is_checked($plugin_fb['data']['values']['fb_show_recom'], 1) ?> /><label for="param_fb_show_recom">Show recommendations</label>
    </td>
	</tr>
...
<table width="100%" summary="" class="br_module_table_preview">
	...
	<tr>
		<td>
      <input type="checkbox" value="1" class="" onclick="PHPWCMS_MODULE.SP.load_preview('activity');" id="prev_check" />
